...
def write_version_py(filename='dynamiq_samplers/version.py'):
    cnt = """
...
def buildKeywordDictionary():
    ...
    setupKeywords = {}
    setupKeywords["name"]              = "dynamiq_samplers"
    ...
    setupKeywords["download_url"]      = "http://github.com/dynamiq-md/dynamiq_samplers"
    setupKeywords["packages"]          = ['dynamiq_samplers', 
                                          'dynamiq_samplers.tests']
    setupKeywords["package_dir"]       = {
        'dynamiq_samplers' : 'dynamiq_samplers',
        'dynamiq_samplers.tests' : 'dynamiq_samplers/tests'
    }
